...
//               <div
//                 key={folder._id}
//                 className={`rounded-3xl shadow-lg p-5 relative ${bgColor} text-black hover:shadow-xl transition-shadow cursor-pointer`}
...
//                 {/* Avatars (optional - you can remove if not needed) */}
